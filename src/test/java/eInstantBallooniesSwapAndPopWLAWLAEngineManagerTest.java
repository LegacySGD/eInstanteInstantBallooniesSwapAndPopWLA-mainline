...
public class eInstantBallooniesSwapAndPopWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(eInstantBallooniesSwapAndPopWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/eInstantBallooniesSwapAndPopWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/eInstantBallooniesSwapAndPopWLAIW/InitOutcome.xml").getDocumentElement();
